"""A module for the persistent layer"""
...
class DatabaseManager:
    ...
    def _execute(
        ...
        """Take in a SQL statement and optionally the values for placeholders and executes it with SQLite"""
        try:
    ...
    def alter_table(self, table_name: str, columns: t.Dict[str, str]) -> None:
        """
        Takes in a table and alters it with the ALTER TABLE statement to be executed with SQLite
        """
        columns_with_types = []
    ...
    def drop_table(self, table_name: str) -> None:
        """Takes in a table name to delete using DROP TABLE statement to be executed with SQLite"""
    ...
    def add(self, table_name: str, data: t.Dict[str, str]) -> None:
        """
        Takes a table name to INSERT data INTO and a data dictionary with columns
    ...
    def join_tables(self, table_name_1:str, column_1: str, table_name_2: str, column_2:str):
        """
        Takes in a 2 tables and joins them with the INNER JOIN statement to be executed with SQLite
        """

        statement = dedent(f"""SELECT * FROM {table_name_1} INNER JOIN {table_name_2} ON {table_name_1}.{column_1} = {table_name_2}.{column_2};
                    """)
